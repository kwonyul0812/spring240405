...
//                """;
    ...
    public void method2(@RequestParam(value = "name", required = false)
                        String searchName, Model model) throws Exception {
    ...
    public String method4(String search, Model model) throws Exception {
        ...
        try (conn; pstmt; rs) {
            while (rs.next()) {
                ...
                MyBean254Customer customer = new MyBean254Customer(id, name, contactName, address, city, postalCode, country);
    ...
    public String method6(String search, Model model) throws Exception {
        ...
        try (pstmt; rs) {
            while (rs.next()) {
                MyBean256Product productList = new MyBean256Product();

                productList.setProductId(rs.getInt(1));
                productList.setProductName(rs.getString(2));
                productList.setSupplierID(rs.getInt(3));
                productList.setCategoryID(rs.getInt(4));
                productList.setUnit(rs.getString(5));
                productList.setPrice(rs.getDouble(6));
