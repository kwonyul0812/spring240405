...
public class Controller28 {
    ...
    @PostMapping("sub1")
    public String sub1(MyBean254Customer customer, RedirectAttributes rttr) throws Exception {
    ...
    // todo : 새 직원 입력하기 , sub3 sub4 활용
    @GetMapping("sub2")
    public void sub2() {
    }

    @PostMapping("sub2")
    public String sub2(MyBean258Employee employee, RedirectAttributes rttr) throws Exception {
        ...
        try (conn; pstmt;) {
            ...
            int rowCount = pstmt.executeUpdate();
            if (rowCount > 0) {
                rttr.addFlashAttribute("message", "직원 등록 완료했습니다.");
            }
        }
