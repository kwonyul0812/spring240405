...
public class Controller11 {
    ...
    public void method2(Model model) {
        model.addAttribute("attr1", List.of(3)); // ${empty attr1} false
        model.addAttribute("attr2", List.of()); // ${empty attr2} true

        model.addAttribute("attr3", Map.of("a", "b")); // ${empty attr3} false
        model.addAttribute("attr4", Map.of()); // ${empty attr4} true
    }
}
