...
public class Controller22 {
    ...
    @GetMapping("sub3")
    public void method3() {
        // login form에 있는 jsp(view)로 forward
    }
    ...
    public String method7(String id, String password, RedirectAttributes redirectAttributes) {
        ...
        // 성공하면 로그인 성공했다는 경로로 redirect 응답
...
//    }
    ...
    @PostMapping("sub17")
    public String sub17(String id, String pw, RedirectAttributes rttr) {
        boolean ok = id.equals(pw);
        ...
        if (ok) {
            ...
            rttr.addFlashAttribute("message", "로그인 실패하였습니다.");
