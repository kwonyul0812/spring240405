...
public class Controller20 {
    ...
    public void sub6(String address, String type, Model model) {
        model.addAttribute("address", address + "의 " + type + " 맛집 검색결과");
    }
    ...
    @RequestMapping("sub8")
    public void sub8(MyBean201 data, Model model) {
    ...
    public void sub18(String name, String city, String address, Model model) {
        System.out.println("name = " + name);
        System.out.println("city = " + city);
        System.out.println("address = " + address);
    }
