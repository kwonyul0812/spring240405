...
public class Controller31 {
    ...
    public void method5() {
        ...
        MyBean258Employee e = mapper.selectOneEmployee();
    ...
    // 가격이 5 ~ 55 사이인 상품(Products) 가격순으로 조회 후 콘솔에 출력
    @GetMapping("sub12")
    public void method12(Double min, Double max) {
        List<MyBean256Product> products = mapper.selectProductsByPrice(min, max);
